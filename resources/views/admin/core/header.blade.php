        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
                    <img src="{{asset('storage/'.\Illuminate\Support\Facades\Auth::user()->image)}}" class="avatar img-fluid rounded mr-1" /> <span class="text-dark">{{\Illuminate\Support\Facades\Auth::user()->name}}</span>
                </a>
